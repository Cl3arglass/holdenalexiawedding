    ...
    <div className={styles.container}>
      ...
      <main className={styles.main}>
        <Tabs initialValue="1">
          ...
          <Text h2>Cermony + Reception</Text><br /> 
          <Text font="1.5rem" marginTop={"-25px"} marginBottom={"0px"}>January 14, 2023 - 3:00pm</Text><br /> 
          ...
          <Text font="1rem" marginTop={"25px"} marginBottom={"0px"}>Formal attire<br /> Adults please</Text>
          </Tabs.Item>
